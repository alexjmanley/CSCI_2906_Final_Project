...
public class Pane2 extends GridPane {
	...
	Pane2(){
		...
		tfWeight.setOnMouseClicked(e -> {
			tfWeight.setStyle("-fx-text-inner-color: black");
			tfWeight.clear();
		});
		tfGoalWeight.setStyle("-fx-text-inner-color: gray");
		tfGoalWeight.setOnMouseClicked(e -> {
			tfGoalWeight.setStyle("-fx-text-inner-color: black");
			tfGoalWeight.clear();
		});
	...
	public void populateVariables() {
		...
		this.vtraining = this.cboTraining.getValue().trim(); 
		this.vcardio = this.cboCardio.getValue().trim(); 
