...
public class RestPane extends Pane{
	...
	Object startDate2 = startDate1.clone(); 
		...
		Label sleepGoals = new Label("Weekly Sleep Goal: 56 hrs             Daily Sleep goal: 8 hrs");
		sleepGoals.setLayoutX(100);
		sleepGoals.setLayoutY(100); 
		sleepGoals.setFont(Font.font("Times New Roman", FontWeight.BOLD, FontPosture.REGULAR, 20)); 
		sleepGoals.setTextFill(Color.WHITE);
		
		Label howToUse = new Label("*Enter how many hours of sleep you get each day then press Calculate to "
		...
		Label[] gpLabels = {new Label("Previous Week Sleep: "), 
		...
		this.getChildren().addAll(back, startDate, endDate, sleepGoals, gpDays, howToUse); 
		}
		catch(IllegalArgumentException ex) {
			this.getChildren().clear();
			gpDays.getChildren().clear(); 
			buildPane();
		}
